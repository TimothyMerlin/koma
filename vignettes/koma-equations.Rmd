...
`dummies()` is expanded before validation, so the expanded names are treated
exactly like any hand-typed variable: each one (`covid_1`, `covid_2`, ...)
must still be declared in `exogenous_variables`.
